...
from repks.apps.accounts.api.v1.views.login import LoginView, LogoutView
from repks.apps.accounts.api.v1.views.password import (
    ChangePasswordAPIView,
    ConfirmResetPasswordAPIView,
    ResetPasswordAPIView,
)
from repks.apps.accounts.api.v1.views.registration import RegistrationAPIView
from repks.apps.accounts.api.v1.views.user_profile import UserProfileAPIView
